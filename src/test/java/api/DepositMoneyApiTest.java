...
public class DepositMoneyApiTest extends BaseApiTest {
...
//        Create user + account
        ...
        CreateAccountResponseModel createAccountResponseModel = new UserSteps(user.getUsername(), user.getPassword()).createAccount();
