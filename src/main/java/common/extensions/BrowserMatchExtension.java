...
public class BrowserMatchExtension implements ExecutionCondition {
    ...
    public ConditionEvaluationResult evaluateExecutionCondition(ExtensionContext context) {
        ...
        if (matches) {
            ...
            return ConditionEvaluationResult.disabled("Тест пропущен, так как текущий браузер " + currentBrowser + " не" +
                    " находится в списке допустимых браузеров для теста." + "\n" +
                    "Список допустимых браузеров: " + Arrays.toString(annotation.value()));
        }
    }
}
